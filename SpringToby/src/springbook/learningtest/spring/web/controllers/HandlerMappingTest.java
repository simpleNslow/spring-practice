...
public class HandlerMappingTest extends AbstractDispatcherServletTest {
	...
	// ControllerBeanNameHandlerMapping : Deprecated as of 4.3
	/*
	@Test
	...
	*/
	...
	// ControllerClassNameHandlerMapping : Deprecated as of 4.3
	/*
	@Test
	...
	*/
	...
	public void orderOfHM() throws ServletException, IOException {
		...
		setClasses(BeanNameHM.class, RequestMappingHM.class, Controller4.class, Controller5.class);
	...
	static class RequestMappingHM extends RequestMappingHandlerMapping {
		public RequestMappingHM() { setOrder(1); }
	}
